...
const (
	MetricService_StreamMetrics_FullMethodName = "/proto.MetricService/StreamMetrics"
)
...
func (c *metricServiceClient) StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamMetricsRequest, StreamMetricsResponse], error) {
...
type MetricService_StreamMetricsClient = grpc.ClientStreamingClient[StreamMetricsRequest, StreamMetricsResponse]
...
func (UnimplementedMetricServiceServer) StreamMetrics(grpc.ClientStreamingServer[StreamMetricsRequest, StreamMetricsResponse]) error {
...
func _MetricService_StreamMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MetricServiceServer).StreamMetrics(&grpc.GenericServerStream[StreamMetricsRequest, StreamMetricsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MetricService_StreamMetricsServer = grpc.ClientStreamingServer[StreamMetricsRequest, StreamMetricsResponse]
